...
const ExperimentResultsView: React.FC<ExperimentResultsViewProps> = ({ 
  ...
  // Ensure we have data before rendering results
  if (!data) {
    return (
      <Card className="shadow-md">
        <CardContent className="p-6 flex justify-center items-center min-h-[400px]">
          <div className="flex flex-col items-center">
            ...
            <p className="text-muted-foreground mb-2">No results available yet</p>
      ...
      <CardHeader className="bg-primary/5 border-b border-primary/10">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <CardTitle>{experiment_name || 'Training Results'}</CardTitle>
          </div>
