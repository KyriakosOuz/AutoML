  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex justify-between items-center px-4 py-2 border-b bg-background">
        <h3 className="font-medium">Mistral AI Assistant</h3>
      ...
      <ScrollArea className="flex-1 p-4">
        {messages.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-full text-center px-4 py-12">
            <h3 className="text-lg font-medium mb-2">Mistral AI Assistant</h3>
            <p className="text-sm text-muted-foreground mb-4">
              I can help answer questions about your data, models, and ML processes. 
